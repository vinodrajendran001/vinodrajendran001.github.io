...
<center><img width="500" height="300" src="assets/img/siamese_NN_one_shot_learning/siamese_cnn.png"></center>
<center>*Fig. 1: Convolutional Siamese Network Architecture* [2]</center>
...
<center><img width="500" height="350" src="assets/img/siamese_NN_one_shot_learning/siamese_cnn_koch.png"></center>
<center>*Fig. 2: Siamese Network Architecture by Koch et al.* [2]</center>
...
<center><img width="500" height="200" src="assets/img/siamese_NN_one_shot_learning/omniglot_dataset.png"></center>
<center>*Fig. 3: Omniglot dataset overview*</center>
...
<center><img width="350" height="200" src="assets/img/siamese_NN_one_shot_learning/siamese_loss.png"></center>
<center>*Fig. 4: Network’s Training and Validation Loss*</center>
...
| :----------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: |
| <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_m.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_m.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_i2.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_i3.png"> |
        
<center>Fig. 5: Case 1 Main image and image set</center>
...
|                                         Main Image                                         |                                           Image1                                            |                                           Image2                                            |                                           Image3                                            |
| :----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: |
| <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_m.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_i1.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_i2.png"> | <img width="150" height="150" src="assets/img/siamese_NN_one_shot_learning/oneshot_i3.png"> |

<center>Fig. 7: Case 2 Main image and image set</center>


#### Output

<center><img width="350" height="250" src="assets/img/siamese_NN_one_shot_learning/siamese_worstcase.png"></center>
<center>Fig. 8: Best match when the image set does not contain image similar to main image</center>
